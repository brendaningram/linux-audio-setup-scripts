#!/bin/bash
# ---------------------------
# This is a bash script for configuring Linux Mint 21 (vanessa) for pro audio.
# ---------------------------
# NOTE: Execute this script by running the following command on your system:
# wget -O ~/install-audio.sh https://raw.githubusercontent.com/brendaningram/linux-audio-setup-scripts/main/mint/21/install-audio.sh && chmod +x ~/install-audio.sh && ~/install-audio.sh
...
# 6.36
# ---------------------------
wget -O reaper.tar.xz http://reaper.fm/files/6.x/reaper680_linux_x86_64.tar.xz
mkdir ./reaper
